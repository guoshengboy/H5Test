class Tools {
  ...
  encodeUriQuery(value, pctEncodeSpaces) {
	 ...
	 * @return {String} 
	 */
  decodeUriQuery(value, pctEncodeSpaces) {
    return decodeUriQuery(value
      .replace('@', /%40/gi)
      .replace(':', /%3A/gi)
      .replace('$', /%24/g)
      .replace(',', /%2C/gi)
      .replace(';', /%3B/gi)
      .replace((pctEncodeSpaces ? '%20' : '+'), /%20/g))
  }
 ...
 */
  ...
  */
  ...
  /**
  * 两个日期间的天数
  * @param  {String} obj 开始日期，Date或字符串的日期
  * @param  {Object} obj 结束日期，Date或字符串的日期
  * @return {int} 
  */
  howDaysInTwoDate(sdt, edt) {
